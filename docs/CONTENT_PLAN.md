...
Logo、济州岛人物拼贴与四块蛋糕正式素材均已接入并通过验收；固定路径记录在 `docs/ASSET_MANIFEST.md`。
...
正式素材：`assets/images/about/about-main-collage.webp`，用于自我介绍左侧人物拼贴。
...
| `05` | `最近在听的` | `ON REPEAT LATELY` | 音乐 | `assets/images/recipes/recipe-song.webp` | `#6F8FAF` | 原生音频试听与 YouTube 外部链接 |
| `06` | `最近感兴趣的事` | `MY LATEST RABBIT HOLE` | Vibe Coding | `assets/images/recipes/recipe-vibe-coding.webp` | `#B8665C` | TATA Codex桌宠 ZIP 下载 |
| `07` | `一个生活的瞬间` | `A MOMENT I’LL ALWAYS REMEMBER` | 日常 | `assets/images/recipes/recipe-daily-moment.webp` | `#A46068` | 小红书外部链接 |
